      ...
      <div className="relative z-10">
        ...
        <div className="border-t border-kaleo-cream/10 py-6">
          <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            {/* Built with love by Moe Barbar */}
            <p className="font-body text-xs text-kaleo-cream/40 flex items-center gap-1">
              Built with <span className="text-red-400">❤</span> by{' '}
              <a
                href="https://www.instagram.com/immoebarbar"
                target="_blank"
                rel="noopener noreferrer"
                className="text-kaleo-terracotta hover:text-kaleo-cream transition-colors underline underline-offset-2"
              >
                Moe Barbar
              </a>
            </p>
